...
class table(QObject):    
    ...
    def slider1(self, message):
        ...
        slider1 = message
        #print(button1)
        client.publish("trainer_iot_upi_01/led1",str(slider1))  
                
    @pyqtSlot(str)
    def slider2(self, message):
        global slider2
        slider2 = message
        #print(button2)
        client.publish("trainer_iot_upi_01/led2",str(slider2))  
        
            
            
    @pyqtSlot(str)
    def slider3(self, message):
        global slider3
        slider3 = message
        #print(button3)
        client.publish("trainer_iot_upi_01/led3",str(slider3))  
